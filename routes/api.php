...
Route::get('/instructors/{instructor}/courses', function (Instructor $instructor) {
...
Route::get('/rooms/{room}/courses', function (Room $room) {
    return DB::table('assignments')
        ->join('instructors_rooms_sections', 'instructors_rooms_sections.id', '=', 'assignments.instructors_rooms_sections_id')
        ->join('sections', 'sections.id', '=', 'instructors_rooms_sections.section_id')
        ->join('courses', 'courses.id', '=', 'sections.course_id')
...
Route::get('/programs/{program}/courses', function (Program $program) {
    return DB::table('assignments')
        ->join('instructors_rooms_sections', 'instructors_rooms_sections.id', '=', 'assignments.instructors_rooms_sections_id')
        ->join('sections', 'sections.id', '=', 'instructors_rooms_sections.section_id')
        ->join('courses', 'courses.id', '=', 'sections.course_id')
