...
@section('content')
    <div class="container-fluid px-0">
        <div class="d-flex" style="height: calc(100vh - 72px); overflow: hidden;">
            ...
            <section class="px-3 pb-3 pt-0 d-flex flex-column"
                style="flex: 1 1 auto;  overflow: hidden; background-color: #ebeaea;">
                <div id="calendar" class=" mt-3" style="flex: 1 1 auto; background-color: #fff;"></div>
            </section>
            <div class="bg-white border-start d-flex align-items-start justify-content-center text-center px-3 pt-3 flex-shrink-0"
                style="flex: 0 0 15%;">
                <div class="w-100 position-relative" style="height: 100%;">
